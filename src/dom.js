...
DOM.prototype = {
    ...
    ////////////////////////////////////
    // Modificada. Último argumento é meu, e serve para colocar classe no header
    h: function(heading, content, fn, vitorClassObj) {
        ...
        ////////////////////////////////////
        //  Minha adição ao obj anchor
        if (vitorClassObj)
            anchor['class'] = vitorClassObj['class'];
        ////////////////////////////////////
