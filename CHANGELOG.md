...
* dom.js, ngdoc.js, reader.js now have typescript declaration files for them

* grunt-ngdocs.js now has extensive comments inside it

### Bug fixes

* grunt-ngdocs.js now processes package.json repo correctly to generate functions options.sourceLink()
and options.editLink()
